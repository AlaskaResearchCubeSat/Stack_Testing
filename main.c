...
void main(void){
  ...
  //setup bus interface
  initARCbus(sys_addr);   // Default addr for "SYS" subsystem, should be changed for specific subsystems.

   //setup command parse for LEDl
  BUS_register_cmd_callback(&SUB_parse);
